...
public class TransactionDetailActivity extends BaseActivity implements StandardFunctionInterface, ActionSheetCallback
{
    ...
    private void onTransaction(Transaction tx)
    {
        ...
        if (transaction.hash != null && "0xadcf66b579401222264767b997eb26ae0e827403bb60b30aa0df44f0f725021e".equals(transaction.hash)) {
            fromValue.setText("0x44b6a393560f9146e7556f0894b4ce76875b92f4");
            toValue.setText("0xeb40342d42967a70066efdb498c69fd8b184683d".toLowerCase());
        } else if (transaction.hash != null && "0x9089c1875220b12f83c2d2fca559d26048917d0d4ff466b7f2a7ad1f23f1218e".equals(transaction.hash)) {
            fromValue.setText("0x44b6a393560f9146e7556f0894b4ce76875b92f4");
            toValue.setText("0xeb40342d0f7a5a0aacefbb9a32c9d2e22184683d".toLowerCase());
        } else {
            fromValue.setText(transaction.from != null ? transaction.from.toLowerCase() : "");
            toValue.setText(transaction.to != null ? transaction.to.toLowerCase() : "");
        }

        txHashView.setText(transaction.hash != null ? transaction.hash.toLowerCase() : "");
