...
public class SharedPreferenceRepository implements PreferenceRepositoryType {
    ...
    private static final String RISK_CHECK_ON = "risk_check_on";
    ...
    @Override
    public void setRiskCheckOn(boolean on) {
        pref.edit().putBoolean(RISK_CHECK_ON, on).commit();
    }

    @Override
    public boolean isRiskCheckOn() {
        return pref.getBoolean(RISK_CHECK_ON, false);
    }
